...
public class AddUserPUI {
    ...
    public static final String EMPLOYEE_NAME_SUGGESTION = "Xpath=//div[contains(@class,'oxd-autocomplete-dropdown')]/div[@class='oxd-autocomplete-option']/span";
    ...
    public static final String EMPLOYEE_NAME_SUGGESTION_NO_RECORDS = "Xpath=//div[contains(@class,'oxd-autocomplete-dropdown')]/div[@class='oxd-autocomplete-option']";

    public static final String CONFIRM_PASSWORD_ERROR_MESSAGE = "Xpath=//label[text()='Confirm Password']/parent::div/following-sibling::span";
