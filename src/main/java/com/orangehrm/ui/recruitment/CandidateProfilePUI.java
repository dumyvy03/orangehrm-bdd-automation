...
public class CandidateProfilePUI {
    ...
    public static final String JOB_VACANCY_SELECTED_TEXT = "Xpath=//label[text()='Job Vacancy']/parent::div/following-sibling::div//div[@class='oxd-select-text-input']";
    ...
    public static final String RESUME_UPLOADED_FILE_NAME = "Xpath=//label[text()='Resume']/parent::div/following-sibling::div//p[contains(@class,'orangehrm-file-name')]";
